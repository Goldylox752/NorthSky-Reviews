...
export const metadata = {
  title: "All AI Tools & Software Reviews 2026 | NorthSky Reviews",
  ...
  alternates: {
    canonical: "https://northsky-reviews.vercel.app/all-tools",
  },
};
...
export default function AllToolsPage() {
  ...
  const schema = {
    ...
    "@type": "CollectionPage",
    "name": "All AI Tools & Software Reviews",
    "description":
    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="bg-gradient-to-br from-slate-950 via-indigo-950 to-blue-900 px-6 py-24 text-center text-white">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <span className="rounded-full bg-blue-500/20 px-5 py-2 font-bold text-blue-300">
            🚀 Software Directory
          </span>
