...
export default function sitemap() {
  ...
  const reviewPages = toolList.map((tool) => ({
  ...
  const categoryPages = categoryList.map((category) => ({
  ...
  const comparisonPages = comparisonList.map((item) => ({
  ...
  const guidePages = guideList.map((guide) => ({
