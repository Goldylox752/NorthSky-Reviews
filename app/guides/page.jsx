...
export const metadata = {
  ...
  alternates: {
    canonical: "https://northsky-reviews.vercel.app/guides",
  },
};
...
export default function GuidesPage() {
  ...
  const schema = {
    ...
    url: "https://northsky-reviews.vercel.app/guides",
    ...
    mainEntity: {
      ...
      itemListElement: featuredGuides.map((guide, index) => ({
        ...
        url: `https://northsky-reviews.vercel.app/guides/${guide.slug}`,
      })),
    },
  };
    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="bg-gradient-to-br from-slate-950 via-indigo-950 to-blue-900 px-6 py-24 text-center text-white">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-xl text-slate-300">
            ...
            cybersecurity, and technology decisions.
          </p>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-4">
            {[
              ...
              <Link
                key={title}
                href={url}
                className="rounded-2xl bg-white p-6 text-center font-bold shadow hover:shadow-xl"
              >
                {title}
              </Link>
            ))}
      ...
      <section className="bg-blue-600 px-6 py-20 text-center text-white">
        ...
        <p className="mt-5 text-blue-100">
          Learn how AI, software, and technology can improve your workflow.
        </p>
